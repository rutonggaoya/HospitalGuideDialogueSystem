...
from extractor.bilstm_utils import result_to_json
from extractor.bilstm_utils import iobes_iob, iob_iobes
...
class Model(object):
    ...
    def embedding_layer(self, char_inputs, seg_inputs, config, name=None):
        ...
        embedding = []
        # with tf.variable_scope("char_embedding" if not name else name, reuse=True), tf.device('/cpu:0'):
        with tf.variable_scope("char_embedding" if not name else name, reuse=False), tf.device('/cpu:0'):
